...
mavenPublishing {
  ...
  pom {
    ...
    url.set("https://github.com/kostack/fixtures")
    ...
    scm {
      connection.set("scm:git:git://github.com/kostack/fixtures.git")
      developerConnection.set("scm:git:ssh://github.com/kostack/fixtures.git")
      url.set("https://github.com/kostack/fixtures")
    }
  }
}
